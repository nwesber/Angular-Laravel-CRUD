app.controller('QuoteController', function($scope, $http, $state){
  ...
  $scope.addQuote = function(){
    ...
    $http.post("http://localhost/Laravel-Angular-CRUD/api/public/api/quote", data).then(function successCallback(response) {
      $state.reload();
    });
  }
  ...
  $scope.deleteQuote = function(id){
    $http({
      method: 'DELETE',
      url: 'http://localhost/Laravel-Angular-CRUD/api/public/api/quote/' + id
    }).then(function successCallback(response) {
      $state.reload();
    }, function errorCallback(response) {
  ...
  $scope.updateQuote = function(){
    var id = $scope.id;
    var url = 'http://localhost/Laravel-Angular-CRUD/api/public/api/quote/' + id;
    var data = {
      "content": $scope.content
    }
